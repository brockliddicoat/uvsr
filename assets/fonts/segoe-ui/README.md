...
this directory holds local, unmodified Segoe UI files from the developer's
Windows installation. font binaries are ignored by Git and are not repository
or release assets.

| Local File | Face | Windows Source |
| --- | --- | --- |
| `segoeui.ttf` | regular | `%WINDIR%/Fonts/segoeui.ttf` |
