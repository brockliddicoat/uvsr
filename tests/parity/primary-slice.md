...
the fixtures retain AGFX copyright 2026 Amélie Heinrich and the complete [MIT notice](../../legal/licenses/AGFX-MIT.txt). the Rust compute shader and copy fixture retain that attribution. the shader's compile-only evidence does not close its pending native dispatch. no ShaderToHuman files or goldens are imported in this checkpoint.
