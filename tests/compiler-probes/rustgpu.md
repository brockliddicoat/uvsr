...
these fixtures are explicit SPIR-V tool inputs, rather than Rust source compiletests. they expose pipeline assumptions and the first failing stage. they do not establish raw Rust pointer semantics, a shader-library API, GPU correctness, or upstream acceptance. [execution](../../docs/execution.md) owns observed results and exact source/configuration identities. tested dependency changes are preserved in the [prerequisite patch record](../../patches/rustgpu-prerequisites/README.md).
