"""Run the six embedded Rust shader cases with explicit Vulkan validation.
...
def main():
    ...
    source = Path(__file__).with_name("physical_readback.rs")
    metadata = {}
    for level in [0, 3]:
        stem = args.shader_dir / f"physical_readback_opt{level}"
    ...
    report = {
        "schema_version": 1, "case_id": "theta.m2.ngapi.physical_readback",
        ...
        "source_sha256": sha256(source), "required_shader_cases": 6,
