...
:missing_python
echo Python 3.10 or newer is required to check document Title Case. 1>&2
exit /b 1

:run_codex_python
"%CODEX_PYTHON%" "%~dp0check_document_title_case.py" %*
exit /b %errorlevel%

:run_py
py -3 "%~dp0check_document_title_case.py" %*
exit /b %errorlevel%

:run_python3
python3 "%~dp0check_document_title_case.py" %*
exit /b %errorlevel%

:run_python
python "%~dp0check_document_title_case.py" %*
exit /b %errorlevel%
