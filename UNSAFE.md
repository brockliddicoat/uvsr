...
| RustGPU contribution | tracked safe-Rust prerequisite patches repair rspirv placement, SPIR-T grammar metadata and RustGPU concrete interfaces. later untyped/heap IR stages still fail. no verified unsafe shader boundary is claimed |
