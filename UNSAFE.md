...
| RustGPU contribution | tracked safe-Rust prerequisite patches pass all 16 assembly-input probes through parser, SPIR-T, linker and optimizer with both installed and compiled tools. Rust shader code generation and runtime work remain pending. no verified unsafe shader boundary is claimed |
