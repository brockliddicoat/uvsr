...
| RustGPU contribution | tracked safe-Rust prerequisite patches pass all 16 installed-tools assembly-input probes through parser, SPIR-T, linker and optimizer. compiled-tools integration and Rust shader code generation remain pending. no verified unsafe shader boundary is claimed |
