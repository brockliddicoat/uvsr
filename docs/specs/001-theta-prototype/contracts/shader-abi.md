...
[E-018](../../../execution.md#e-018-2026-09-19-compiled-aligned-physical-accesses) verifies scalar physical u32 read/write code generation with Aligned 4 and removal of alignment from logical accesses while retaining other memory flags and scopes. this is compile/validation evidence only. aggregate accesses, complete pointer operations, actual qptr memory-operand lowering/lifting and runtime host obligations remain open.
