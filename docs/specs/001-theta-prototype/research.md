...
| D017 | after E-035, complete the full declared Vulkan AGFX and ShaderToHuman Rust ports as the active objective | explicit user instruction to finish the reusable testbed for advanced scene/renderer experiments. supersedes D011's stopping point and sequencing, without changing source parity, safety, Vulkan priority or the independent upstream contribution boundary |
