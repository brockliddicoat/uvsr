...
- [UVSR Public License](../../LICENSE)
- [License Inventory](../licenses/README.md)
- [Body And Notice Integrity Check](../../tools/check_legal_inventory.py)

## Commercial Clearance

The public license intentionally permits only its defined noncommercial
purposes; a separate commercial agreement can cover only first-party rights
UVSR owns or controls. It cannot override third-party licenses, asset terms, or
the clearance gaps recorded in this registry.
