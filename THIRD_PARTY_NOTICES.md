...
| --- | --- | --- |
| [AGFX](https://github.com/AmelieHeinrich/agfx) | `f91b108a111d2ca3ca4b6586b6cb5dd750064fd7` | API behavior, backend, ownership, and test reference for the Rust framework |
...
| [NoGraphicsAPI](https://github.com/sebbbi/NoGraphicsAPI) | `d60b10bdfe15c0f350d6d291d8e06afef3fe7d38` | physical-pointer and native descriptor-heap consumer |
| [ShaderToHuman](https://github.com/electronicarts/ShaderToHuman) | `d6f98b7d67da802053cd9c702082fa741dec42e7` | shader regression and documentation test source |
