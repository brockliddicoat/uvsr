...
namespace uvsr
{
    ...
    inline constexpr auto UiSettingsCommandCatalog = std::array{
        ...
        // Denoising.
        Value("denoising.ao.method", Kind::Enum, Section::Denoising, "none|reblur"),
        ...
        Value("denoising.gi.method", Kind::Enum, Section::Denoising, "none|reblur|relax"),
        ...
        Value("denoising.shadows.method", Kind::Enum, Section::Denoising, "none|sigma"),
        ...
        Value("denoising.sky.method", Kind::Enum, Section::Denoising, "none|reblur|relax"),
