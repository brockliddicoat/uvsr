...
#define UVSR_LIGHTING_SOURCE_ENVIRONMENT (1u << 1u)
#define UVSR_LIGHTING_SOURCE_INDIRECT_DIFFUSE (1u << 2u)
#define UVSR_LIGHTING_SOURCE_INDIRECT_SPECULAR (1u << 3u)
#define UVSR_LIGHTING_SOURCE_ALL 0x0fu
