...
namespace uvsr
{
    ...
    public:
        ...
        ~RendererLightProbeProcessing() noexcept;
        RendererLightProbeProcessing(const RendererLightProbeProcessing&) = delete;
        RendererLightProbeProcessing& operator=(const RendererLightProbeProcessing&) = delete;
        RendererLightProbeProcessing(RendererLightProbeProcessing&&) = delete;
        RendererLightProbeProcessing& operator=(RendererLightProbeProcessing&&) = delete;
    ...
    private:
        ...
        RendererShaderFactory* m_ShaderFactory = nullptr;
        ...
        TextureSubresourcesEntry* m_TextureSubresourceCache = nullptr;
        size_t m_TextureSubresourceCount = 0u;
        size_t m_TextureSubresourceCapacity = 0u;
        PipelineEntry* m_PipelineCache = nullptr;
        size_t m_PipelineCount = 0u;
        size_t m_PipelineCapacity = 0u;
    };
}
